DecCash pool
====================
Formerly known as cryptonote-forknote-pool, forked from TurtleCoin and adjusted for DecCash (DXC) coin.
...
Rebuild the coin from the following GitHub repository: https://github.com/deccashcoin/deccashcoin-pool using the instructions in the repository Readme.md file.

-  Start the daemon in the RPC mode

```
./deccashcoind --enable-cors=* --enable_blockexplorer --rpc-bind-ip=0.0.0.0 --rpc-bind-port=35001
```
...
```
git clone https://github.com/deccashcoin/deccashcoin-pool.git deccashcoin-pool
```
